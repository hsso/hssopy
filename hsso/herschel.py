...
def hifimap(filename, freq0, sideband='USB', subband=1, obsid=1):
...
#             else:
            ...
            longitudes[j-1,k] = hdulist[j].data.field('longitude')[k] -  gildas.deltadot(timestr,
                    filename="/home/miguel/HssO/Hartley2/python/horizons.txt", column=2)
            latitudes[j-1,k] = hdulist[j].data.field('latitude')[k] - gildas.deltadot(timestr,
